...
class CelebAMaskHQ(torchvision.datasets.VisionDataset):
    ...
    classes = [
        ...
        CelebAMaskHQClass('l_eye', 3, (128, 128, 0)),
        CelebAMaskHQClass('r_eye', 4, (0, 0, 128)),
        CelebAMaskHQClass('l_brow', 5, (128, 0, 128)),
        CelebAMaskHQClass('r_brow', 6, (0, 128, 128)),
        CelebAMaskHQClass('l_ear', 7, (128, 128, 128)),
        CelebAMaskHQClass('r_ear', 8, (64, 0, 0)),
        CelebAMaskHQClass('mouth', 9, (192, 0, 0)),
        CelebAMaskHQClass('u_lip', 10, (64, 128, 0)),
        CelebAMaskHQClass('l_lip', 11, (192, 128, 0)),
        CelebAMaskHQClass('hair', 12, (64, 0, 128)),
        CelebAMaskHQClass('hat', 13, (192, 0, 128)),
        CelebAMaskHQClass('eye_g', 14, (64, 128, 128)),
