...
class CelebAMaskHQ(torchvision.datasets.VisionDataset):
    ...
    classes = [
        ...
        CelebAMaskHQClass('nose', 2, (72, 0, 0)),
        CelebAMaskHQClass('eye_g', 3, (255, 0, 0)),
        CelebAMaskHQClass('l_eye', 4, (51, 255, 255)),
        CelebAMaskHQClass('r_eye', 5, (102, 102, 255)),
        CelebAMaskHQClass('l_brow', 6, (0, 255, 128)),
        CelebAMaskHQClass('r_brow', 7, (153, 51, 255)),
        CelebAMaskHQClass('l_ear', 8, (122, 49, 0)),
        CelebAMaskHQClass('r_ear', 9, (1, 72, 79)),
        CelebAMaskHQClass('mouth', 10, (255, 255, 204)),
        CelebAMaskHQClass('u_lip', 11, (0, 0, 204)),
        CelebAMaskHQClass('l_lip', 12, (255, 80, 80)),
        CelebAMaskHQClass('hair', 13, (204, 255, 229)),
        CelebAMaskHQClass('hat', 14, (255, 255, 0)),
        CelebAMaskHQClass('ear_r', 15, (244, 225, 255)),
        CelebAMaskHQClass('neck_l', 16, (36, 3, 235)),
        CelebAMaskHQClass('neck', 17, (102, 255, 102)),
        CelebAMaskHQClass('cloth', 18, (255, 0, 127)),
    ]
