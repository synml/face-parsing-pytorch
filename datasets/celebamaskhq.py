...
class CelebAMaskHQ(torchvision.datasets.VisionDataset):
    ...
    classes = [
        ...
        CelebAMaskHQClass('eye_g', 3, (64, 128, 128)),
        CelebAMaskHQClass('l_eye', 4, (128, 128, 0)),
        CelebAMaskHQClass('r_eye', 5, (0, 0, 128)),
        CelebAMaskHQClass('l_brow', 6, (128, 0, 128)),
        CelebAMaskHQClass('r_brow', 7, (0, 128, 128)),
        CelebAMaskHQClass('l_ear', 8, (128, 128, 128)),
        CelebAMaskHQClass('r_ear', 9, (64, 0, 0)),
        CelebAMaskHQClass('mouth', 10, (192, 0, 0)),
        CelebAMaskHQClass('u_lip', 11, (64, 128, 0)),
        CelebAMaskHQClass('l_lip', 12, (192, 128, 0)),
        CelebAMaskHQClass('hair', 13, (64, 0, 128)),
        CelebAMaskHQClass('hat', 14, (192, 0, 128)),
